# EIA Summarizer for SNHS S123 Ecology Records

## How to use:

### Option 1:
1. Download EIA_summarizer.pyt and put in new folder in working directory for GIS
2. Open your existing SNHS ArcPro Project
3. Open Catalog Pane
